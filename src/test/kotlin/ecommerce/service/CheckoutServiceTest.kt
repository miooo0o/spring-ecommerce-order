...
class CheckoutServiceTest {
    ...
    fun `successfully executePayment`() {
        ...
        val paymentIntent = PaymentIntent("pi_guri_cute_id",
            1500L, "requires_confirmation", "eur", "pm_card_mastercard", "secret", 16648303L,
        )
    ...
    fun `processCheckout decrease stock`() {
        ...
        val mockOption = mock<Option> {
            on { decreaseStock(2) } doReturn mock()
        }
        val mockOrderItem = mock<OrderItem> {
